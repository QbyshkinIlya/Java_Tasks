...
public class HelloController implements Initializable {
    ...
    public TextField choisDAO;
    public RadioButton radioH;
    public RadioButton radioPg;
    @FXML
    ...
    protected void onHelloButtonClick() {
        try {
            ...
            if (radioH.isSelected()) {
                taskDAO = taskFabrica.getFabDAO("H2");
            } else if (radioPg.isSelected()) {
                taskDAO = taskFabrica.getFabDAO("PG");
            }
    ...
    public void getBD(ActionEvent actionEvent) {
        if (radioH.isSelected()) {
            taskFabrica.getFabDAO("H2");
        } else if (radioPg.isSelected()) {
            taskFabrica.getFabDAO("PG");
        }
    }
}